...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="header_block col-md-12">
            <h1 class="d-block text-center">Отредактировать данные о сотруднике</h1>
        </div>

        <div class="col-md-6">
            @include('staffs.particial.errors')

            {{ Form::model($staff, ['method'=>'PATCH', 'action'=>['StaffsController@update', $staff->id], 'enctype'=>'multipart/form-data']) }}
                ...
                <div class="form-group">
                    ...
                    {{ Form::text('parent_name', $parentName, ['class'=>'form-control', 'id'=>'parent_name', 'required', 'placeholder'=>'Начните ввод ФИО начальника']) }}
                ...
                <div class="form-group">
                    ...
                    {{ Form::input('date', 'employ_at', null, ['class'=>'form-control', 'required']) }}
                </div>

                <div class="form-group">
                    <div class="avatar-container">
                        <img id="imageAvatar" src="{{ $staff->images? asset($staff->images->full_img) : asset('/images/no-photo.jpg') }}" alt="" title="Фото сотрудника" />
                    </div>
